...
主菜单会显示当前脚本版本，例如 `1.0.1`。后续版本按 `1.0.2`、`1.0.3` 递增，`1.0.9` 后进入 `1.1.0`。
...
如果当前已经安装，再选择“安装/更新 Litebox”里的“安装 Litebox”，脚本只会提示“Litebox 当前已经安装”，不会再显示卸载说明。
...
- 单独设置 `TUIC v5` 端口跳跃
- 单独设置 `Hysteria2` 端口跳跃
- 主菜单里会把 `TUIC` / `HY2` 跳跃状态显示在端口信息下面，方便一起看
